...
const ArtworkTable: React.FC = () => {
    ...
    const [tempRows, setTempRows] = useState<number>(12);
    ...
    // Custom header template with overlay panel trigger
        ...
        <div className="card">
            <OverlayPanel ref={op} showCloseIcon>
                <div className="flex flex-column gap-2" style={{ minWidth: '200px' }}>
                    ...
                    <InputNumber
                        id="rowsToSelect"
                        onValueChange={(e) => setTempRows(e.value || 0)}
                        mode="decimal"
                        min={0}
            ...
            {loading && artworks.length === 0 ? (
                ...
                <>
                    ...
                    >
                        {/* Built-in checkbox column with custom header */}
                        <Column
                            selectionMode="multiple" // This column defines the checkbox selection
                            header={selectionHeaderTemplate} // Custom header with dropdown button
